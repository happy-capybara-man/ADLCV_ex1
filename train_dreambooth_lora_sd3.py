...
def log_validation(
    ...
    if is_final_validation and args.final_validation_cpu_offload:
        pipeline.enable_model_cpu_offload()
    else:
        pipeline = pipeline.to(accelerator.device)

    # Lower VRAM pressure during validation image decode/inference.
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Skip end-of-training final validation and only run periodic validation during training.",
    )
    parser.add_argument(
        "--rank",
        type=int,
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        # Free training modules before final inference to avoid OOM.
        ...
        images = []
        if (not args.skip_final_validation) and args.validation_prompt and args.num_validation_images > 0:
            # Final inference
